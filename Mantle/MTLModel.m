...
// Sets the value for key of an object.
//
// obj         - The object for which the value is being set. This value
//               must not be nil.
...
//               validation
//
// Returns YES if `value` set, or NO if an error occurred.
static BOOL MTLSetValue(id obj, NSString *key, id value, NSError **error) {
	@try {
...
- (instancetype)initWithDictionary:(NSDictionary *)dictionary error:(NSError **)error {
	...
	for (NSString *key in dictionary) {
		...
		BOOL success = MTLSetValue(self, key, value, error);
